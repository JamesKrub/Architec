...
(function( window, $ ){
	...
	function PhotoTagger( container, settings ){
		...
		this.message = $( "<div class='" + this.getFullClassName( "message" ) + "'></div>" ); // ชื่อของแท็ก photo-tagger-
