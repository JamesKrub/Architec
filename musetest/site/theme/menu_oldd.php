                ...
                <?php
                  $sql = "select * from feature where fet_id = '2' and fet_enable != '0' ";
                    ...
                    $fet_id = $result['fet_id'];
                            ...
                            <?php echo "<a class='test' id='lv1' href='museshowcat.php?catid=$value[cat1_id]''>$value[cat1_name] <span class='caret'></span></a>"; ?>
                            <ul class="dropdown-menu" id="box2">
<!--                            <ul class="dropdown" id="box2">-->
                                 ...
                                 <?php $sql3 = "SELECT * FROM muse_category_lv3 where ac2_id = '".$value['ac2_id']."'";
                                    ...
                                    <?php if($query3->num_rows > 0){ ?>
                                       <li class="dropdown-submenu">
                                         ...
                                         <?php echo "<a class='test' id='lv2' href='museshowcat.php?catid=$value[ac1_id]'> $value[ac2_name]<span class='caret'></span></a>"; ?>
                                            
                                           <ul class="dropdown-menu" id="box3">

                                                          <!-- LV3 -->
                                                          <?php foreach ($query3 as $key => $value) { ?>
<!--                                                          <li class="menu3">-->
                                                           <li>      
                                                            <?php echo "<a class='test' id='lv3' href='museshowcat.php?catid=$value[ac3_id]'>$value[ac3_name]</a>"; ?>
                                                          </li>
                        ...
                        <?php }else { ?>
                            <li>    <?php echo "<a class='test' href='museshowcat.php?catid=$value[cat1_id]''>$value[cat1_name] </a>"; ?></li>
                        <?php } ?>
          ...
          <script>
            ...
            $(document).ready(function()
            {
              ...
              $('.dropdown-submenu a.test').hover(function(){
                $(this).next('ul #box2').show()
                var x = $('.dropdown-submenu  #lv1 a.test');
                var xx = $('.dropdown-submenu #lv2 a.test');

                $(this).next('ul #box3').toggle()
