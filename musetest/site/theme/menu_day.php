...
<!-- end -->
                ...
                <?php
                  ...
                  $arsql = "SELECT * FROM archive_category where cat1_parent = '0' ";
                  $query1=mysqli_query($link,$arsql) or die("Can't Query3"); ?>
                  ...
                  <ul class="dropdown" id='nav'>
                    ...
                    <?php foreach ($query1 as $key => $value) {  ?>
                      ...
                      ?>
                      <?php
                      $ssql2 = "SELECT * FROM archive_category_lv2 where ac1_id = '".$value['cat1_id']."'";
                      $query2 =mysqli_query($link,$ssql2) or die("Can't Query3"); ?>
                        ...
                        <?php if($query2->num_rows > 0){
                          ...
                          <li class="dropdown-submenu">
                            <!-- ชั้นแรก -->
                            <?php echo "<a $menu4 href='showcat.php?catid=$value[cat1_id]&ac2_id=$value[ac2_id]''>$value[cat1_name] <span class='caret'></span></a>"; ?>
                              <ul id='nav'>
                            ...
                            <?php
                            $ssql3 = "SELECT * FROM archive_category_lv3 where ac2_id = '".$value['ac2_id']."'";
                            $query3 =mysqli_query($link,$ssql3) or die("Can't Query3");  ?>
                       ...
                       <li class="dropdown-submenu contact-details">
                         <!-- sub 2 ที่มี ลูกต่อ -->
                          ...
                          <?php echo "<a $menu4 href='showcatsub2.php?ac3_id=$ac3_id&ac2_id=$value[ac2_id]&ac1_id=$value[ac1_id]'> $value[ac2_name]<span class='caret'></span></a>";   ?>
                              <ul id='nav'>
                                                 ...
                                                 <?php foreach ($query3 as $key => $value) {
                                                   ...
                                                   ?>
                                                              <li>
                                                                ...
                                                                <?php echo "<a $menu4 href='showcat3.php?ac3_id=$value[ac3_id]&ac2_id=$value[ac2_id]&ac1_id=$ac1_id'>$value[ac3_name]</a>"; ?>
                        ...
                        <?php }else {?>
                                  <!-- sub 2 ไม่มีลูกต่อ -->
                           <li>  <?php echo "<a $menu4 class='test' name='ac2_id' href='showcatsub2.php?ac2_id=$value[ac2_id]&ac1_id=$value[ac1_id]'> $value[ac2_name]</a>"; ?></li>
                      <?php } ?>
                      <?php } ?>
                    ...
                    <?php }else { ?>
                    <li>
                        <?php echo "<a $menu4 href='showcat.php?catid=$value[cat1_id] '>$value[cat1_name]</a>"; ?>
                     </li>
                    <?php } ?>
...
<!--      <li><img src="images/black_ribbon_top_right.png" class="black-ribbon stick-top stick-right"/>  </li>-->
