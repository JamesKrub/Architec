...
<html lang='en' xml:lang='en' xmlns='http://www.w3.org/1999/xhtml'>
  <head>
    ...
    <title></title>
     <link href="../../site/test/vr/vr/showvr/css/jquery-ui-1.8.4.all.css" media="screen, projection" rel="stylesheet" type="text/css" />
    <script src="../../site/test/vr/vr/showvr/js/jquery-1.4.2.min.js" type="text/javascript"></script>
    <script src="../../site/test/vr/vr/showvr/js/jquery-ui-1.8.4.all.min.js" type="text/javascript"></script>
    <script src="../../site/test/vr/vr/src/jquery.spritespin.js" type="text/javascript"></script>
   <style type="text/css">
      .preload {
        background : url('../../site/test/vr/showvr/stylesheets/images/ajax-loader.gif') no-repeat 50% 50%;
      }
    </style>
