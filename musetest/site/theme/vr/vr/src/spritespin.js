...
(function($, window) {
  ...
  Spin.prepareBackground = function(data){
    ...
    $.extend(css, data.preloadCSS ||Â {});
    data.preload.css(css).html(data.preloadHtml ||Â "").hide();
  ...
  Spin.rebindEvents = function(data){
    ...
    target.bind('mousedown.spritespin',  beh.mousedown  ||Â $.noop);
    target.bind('mousemove.spritespin',  beh.mousemove  ||Â $.noop);
    target.bind('mouseup.spritespin',    beh.mouseup    ||Â $.noop);
    target.bind('mouseenter.spritespin', beh.mouseenter ||Â $.noop);
    target.bind('mouseover.spritespin',  beh.mouseover  ||Â $.noop);
    target.bind('mouseleave.spritespin', beh.mouseleave ||Â $.noop);
    target.bind('dblclick.spritespin',   beh.dblclick   ||Â $.noop);
    target.bind('onFrame.spritespin',    beh.onFrame    ||Â $.noop);
  
    if (data.touchable){
      target.bind('touchstart.spritespin',  beh.mousedown  ||Â $.noop);
      target.bind('touchmove.spritespin',   beh.mousemove  ||Â $.noop);
      target.bind('touchend.spritespin',    beh.mouseup    ||Â $.noop); 
      target.bind('touchcancel.spritespin', beh.mouseleave ||Â $.noop);
