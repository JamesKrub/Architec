...
<html lang='en' xml:lang='en' xmlns='http://www.w3.org/1999/xhtml'>
  <head>
    ...
    <script src="showvr/js/jquery-ui-1.8.4.all.min.js" type="text/javascript"></script>
    <script src="src/jquery.spritespin.js" type="text/javascript"></script>
   <style type="text/css">
      .preload {
        background : url('showvr/stylesheets/images/ajax-loader.gif') no-repeat 50% 50%;
      }
    </style>
