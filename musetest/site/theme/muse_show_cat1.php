                      ...
                      if ($idobj2 != 0  ) {
                        ...
                        WHERE `muse_category_lv3`.`ac3_id` = '$ac3_id '  ";
                                ...
                                $num_rows_cat3=mysqli_num_rows($querycat3);
                                      ...
                                      // echo "<li><a href='museshowcat.php?catid=$catid''>$objn</a></li>";
                                      // echo "<li>$objtitle</li>";
...
include('connect.php');
           ...
           $sql = "select count(*) FROM muse_pic where obj_refcode = '$refcode' ";
//           $sql = "SELECT DISTINCT * FROM muse_object,muse_category,muse_pic WHERE muse_object.obj_category = muse_category.cat1_id and muse_pic.obj_refcode = muse_object.obj_refcode and muse_object.obj_access = '1' and muse_pic.obj_cover = '1' where obj_refcode = '$refcode' ";
