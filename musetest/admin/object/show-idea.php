            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">ข้อมูลภูมิปัญญา</li>
                    </ol>
                </section>
...
<div class='callout callout-danger'>
	<h4>ต้องการที่จะลบข้อมูลภูมิปัญญา</h4>
	<p>
...
<div id='alert-message' class='alert alert-success alert-dismissable'>
	...
	ลบข้อมูลภูมิปัญญาเสร็จสิ้น
</div>";
}

echo "<a class='btn btn-primary' href='add-idea.php'><i class='fa fa-plus-square fa-lg'></i> เพิ่มข้อมูล</a>";
echo "<a class='btn btn-default pull-right' href='showobj_access-idea.php'> เอกสารรอการอนุมัติ</a><br><br>";
...
echo "<th class='col-sm-1 text-center'>รหัสภูมิปัญญา</th>";
...
else
{
	if(($permission == 'admin') or ($permission == 'superadmin') or ($permission =='editor'))
	{
		...
		$sql = "select * from botanic_idea_object";
	}
	else if ($permission =='user')
	{
...
while($result=mysqli_fetch_array($rs)){ //วนรอบแสดงข้อมูล
	...
	$sql2 = "SELECT * FROM botanic_idea_pic WHERE obj_refcode = '$objrefcode' ORDER BY obj_cover DESC limit 0,1  ";
	...
	echo "<td><img src ='../../pic/big-idea/$objref/$picname' width='250'></td>";
    ...
    <li><a href='edit-idea.php?objectid=$result[obj_id]&refcode=$result[obj_refcode]'>แก้ไข</a></li>
    <li><a href='model/botanic/delete.php?id=$result[obj_id]&refcode=$result[obj_refcode]&type=idea'>ลบ</a></li>
    <li class='divider'></li>";
