            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">สถิติเอกสารจดหมายเหตุ</li>
                    </ol>
                </section>
...
echo "<th class='col-sm-2 text-center'>จำนวนการดาวน์โหลด</th>";
echo "</tr>";
echo "</thead>";
...
while($result=mysqli_fetch_array($rs)){ //วนรอบแสดงข้อมูล
	...
	$sql3 = "SELECT * FROM archive_pic WHERE obj_refcode = '$objrefcode'  ";
	...
	echo "<td class='text-center'>".$num_rows3."</td>";
	echo "<td class='text-center'>".$result['obj_countdownload']."</td>";
$i=$i+1;
}
