...
/////////////////////////
 ...
 $sql2 = "UPDATE `itemsnew` SET
`pic_name` = '$upload->file_copy',
`pic_path` = 'https://www.anurak.in.th/thailue/pic/bigmuse/$dir/$upload->file_copy',
`pic_isThumbnail` = '1'
WHERE  `obj_refcode` = '$dir' LIMIT 1;";
$query = mysqli_query($link2,$sql2) or die("Can't Query2");
