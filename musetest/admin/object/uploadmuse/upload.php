...
echo "xxx $dir";
$path = "../../../pic/bigmuse/".$dir;
$thumbpath = "../../../pic/thumbmuse/".$dir;
$thumbpath2 = "../../../pic/thumbmuse2/".$dir;
...
$upload->upload_dir = '../../../pic/bigmuse/'.$dir.'/';
...
$sql = "INSERT INTO `muse_pic` (`pic_name`, `thumb_name`, `thumb_name2`, `obj_id`, `obj_refcode`,`folder_refcode`, `obj_cover`, `pic_detail`, `listorder`, `pic_open`)
VALUES ('$upload->file_copy', '$upload->the_file', '$upload->the_file2', '0', '$refcode','$dir', '0', '', '0', '1');";
$query = mysqli_query($link,$sql) or die("Can't Query");
