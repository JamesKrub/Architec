                                    ...
                                    <p>
                                        ...
                                        <small>
											...
											if($_SESSION['id'])
											{
												...
												$query2=mysqli_query($sql2) or die("Can't Query");
...
<div class="box box-primary">
	<div class="box-body">
		<div class="row">
			<?php while($row = mysqli_fetch_array($data['query']['muse'])) { ?>
				<div class="col-md-3 text-center">
					<a href="../../pic/bigmuse/<?php echo $row['obj_refcode']."/".$row['pic_name'] ?>" title="<?php $row['obj_title']; ?>" data-gallery><img style="height: 135px !important;" src="../../pic/thumbmuse/<?php echo $row['obj_refcode']."/".$row['thumb_name'] ?>"></a>
					<br>
					<a href="editmuse.php?objectid=<?php echo $row['obj_id']; ?>&refcode=<?php echo $row['obj_refcode']; ?>"><?php echo $row['obj_title']; ?></a>
				</div><!-- /.col-md-3 -->
			<?php } ?>
		</div>
	</div>
