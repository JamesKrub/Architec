...
// $query=mysqli_query($link,$sql) or die("aaa");
									...
									echo "q";
											...
											echo "<label class='col-sm-2 control-label'>ภาพจดหมายเหตุ</label>";
																...
																<div class="col-md-2 tex-center">
																	<div style="margin-bottom: 30px;">
																		<a href="changeTheme.php?theme=<?php echo $row['thm_id']; ?>" class="text-center">
																			...
																			<img style="height: 100px; width: 100%; background-image: url('http://emuseum.in.th/eculture/admin/object/preview-templete/<?php echo $row['thm_file']; ?>.png'); border: 1px solid #ccc; <?php echo ($row['thm_enable'] == 1) ? "filter: brightness(50%); -webkit-filter: brightness(50%); -moz-filter: brightness(50%);" : ""; ?>"/>
																		</a>
																	</div>
																</div>
															<?php }
														...
														<div class="row">
															<div class="col-md-12">
																...
																while($row = mysqli_fetch_array($query)) { ?>
																	<div class="checkbox">
																		<label>
																			<input name="feature[]" type="checkbox" value="<?php echo $row['fet_id']; ?>" <?php echo ($row['fet_enable'] == 1) ? "checked": ""; ?>>
