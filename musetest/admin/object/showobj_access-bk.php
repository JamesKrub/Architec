        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
						เอกสารจดหมายเหตุ
						<small>เอกสารรอการอนุมัติ</small>
                    </h1>
                    <ol class="breadcrumb">
...
echo "<a class='btn btn-primary' href='addobj-1page.php'><i class='fa fa-plus-square fa-lg'></i> เพิ่มข้อมูล</a><br><br>";
...
while($result=mysqli_fetch_array($rs)){ //วนรอบแสดงข้อมูล
	...
	<a href=\"showobj.php?objectid=$result[obj_id]&del=obj\"><img src='images/icon_del.gif'></a></td>";
