            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">ข้อมูลพันธุ์สัตว์</li>
                    </ol>
                </section>
...
echo "<a class='btn btn-default pull-right' href='showobj_access-animal.php'> เอกสารรอการอนุมัติ</a><br><br>";
...
echo "<th class='col-sm-1 text-center'>รหัสพันธุ์สัตว์</th>";
...
else
{
	if(($permission == 'admin') or ($permission == 'superadmin') or ($permission =='editor'))
	{
		...
		$sql = "select * from botanic_animal_object";
	}
	else if ($permission =='user')
	{
...
while($result=mysqli_fetch_array($rs)){ //วนรอบแสดงข้อมูล
    ...
    <li><a href='edit-animal.php?objectid=$result[obj_id]&refcode=$result[obj_refcode]'>แก้ไข</a></li>
    <li><a href='model/botanic/delete.php?id=$result[obj_id]&refcode=$result[obj_refcode]&type=animal'>ลบ</a></li>
    <li class='divider'></li>";
