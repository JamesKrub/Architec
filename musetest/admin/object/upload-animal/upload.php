...
$dir = $_REQUEST['dir'];
//$dir = "test";
$path = "../../../pic/big-animal/".$dir;
$thumbpath = "../../../pic/thumb-animal/".$dir;
$thumbpath2 = "../../../pic/thumb2-animal/".$dir;

if (!file_exists($path)) {
    mkdir($path, 0777);
	mkdir($thumbpath, 07757);
...
$upload->upload_dir = '../../../pic/big-animal/'.$dir.'/';
...
//$sql = " INSERT INTO `botanic_animal_pic` ( `pic_id` , `pic_name` , `thumb_name` , `thumb_name2` , `obj_refcode` ) VALUES ('' , '$upload->file_copy', '$upload->the_file' , '$upload->the_file2' , '$dir');";
//$query=mysql_query($sql) or die("Can't Query");
$sql = " INSERT INTO `botanic_animal_pic` (`pic_name`, `thumb_name`, `thumb_name2`, `obj_id`, `obj_refcode`, `obj_cover`, `pic_detail`, `listorder`, `pic_open`)
