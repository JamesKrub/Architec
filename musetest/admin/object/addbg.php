...
$sql = "UPDATE archive_bg SET `bg_name` = '$archivename', `bg_desc` = '$archivedesc', `bg_entry` = '$archiveentry',
...
`bg_email` = '$archiveemail',`bg_website` = '$archivewebsite'
 WHERE `archive_bg`.`bg_id` = '1' LIMIT 1 ;";
$query=mysqli_query($link,$sql) or die("Can't Query");
}
else
{
...
$sql = "UPDATE archive_bg SET `bg_pic` = '$myfile', `bg_picshow` = '$archivecover'
 WHERE `archive_bg`.`bg_id` = '1' LIMIT 1 ;";
 }
 else
 {
 $sql = "UPDATE archive_bg SET `bg_picshow` = '$archivecover'
 WHERE `archive_bg`.`bg_id` = '1' LIMIT 1 ;";
 }
$query=mysqli_query($link,$sql) or die("Can't Query");
...
$sql = "UPDATE archive_bg SET `bg_watermark` = '$new_name' WHERE `archive_bg`.`bg_id` = '1' LIMIT 1 ;";
$query=mysqli_query($link,$sql) or die("Can't Query");
...
{
echo "INSERT DETAIL";
$sql2 = "INSERT INTO archive_bg (`bg_id`,`bg_name`,`bg_desc`,`bg_entry`,`bg_lat`,`bg_lon`,`bg_number`,
...
#$sql2 = "INSERT INTO `archiveum`.`archive_bg` (`bg_id`,`bg_pic`,`bg_picshow`)
#VALUES ('1', '$myfile','$archivecover');";
$sql2 = "INSERT INTO archive_bg (`bg_id`,`bg_pic`,`bg_picshow`)
VALUES ('1', '$myfile','$archivecover');";
$query2=mysqli_query($link,$sql2) or die("Can't Query");
...
#$sql2 = "INSERT INTO `archiveum`.`archive_bg` (`bg_id`,`bg_pic`,`bg_picshow`)
#VALUES ('1', '$myfile','$archivecover');";
$sql2 = "INSERT INTO archive_bg (`bg_id`,`bg_watermark`,`bg_watermarkshow`)
VALUES ('1', '$myfile','$archivecover');";
$query2=mysqli_query($link,$sql2) or die("Can't Query");
