...
echo "<label class='col-sm-2 control-label'>หัวข้อนิทรรศการ</label>";
...
echo "<div class='form-group'>";
echo "<label class='col-sm-2 control-label'>วันที่เริ่มต้น</label>";
echo "<div class='col-sm-5'>";
echo "<input id='datepicker' data-date-format='dd-mm-yyyy' class='form-control' type='text' name ='datecreate1' value=''>";
echo "</div>";
echo "</div>";

echo "<div class='form-group'>";
echo "<label class='col-sm-2 control-label'>วันที่สิ้นสุด</label>";
echo "<div class='col-sm-5'>";
echo "<input id='datepicker2' data-date-format='dd-mm-yyyy' class='form-control' type='text' name ='datecreate2' value=''>";
echo "</div>";
echo "</div>";
