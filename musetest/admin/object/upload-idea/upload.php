...
$dir = $_REQUEST['dir'];
//$dir = "test";
$path = "../../../pic/big-idea/".$dir;
$thumbpath = "../../../pic/thumb-idea/".$dir;
$thumbpath2 = "../../../pic/thumb2-idea/".$dir;
...
$upload->upload_dir = '../../../pic/big-idea/'.$dir.'/';
...
//$sql = " INSERT INTO `botanic_idea_pic` ( `pic_id` , `pic_name` , `thumb_name` , `thumb_name2` , `obj_refcode` ) VALUES ('' , '$upload->file_copy', '$upload->the_file' , '$upload->the_file2' , '$dir');";
//$query=mysql_query($sql) or die("Can't Query");

$sql = " INSERT INTO `botanic_idea_pic` (`pic_name`, `thumb_name`, `thumb_name2`, `obj_id`, `obj_refcode`, `obj_cover`, `pic_detail`, `listorder`, `pic_open`)
VALUES ('$upload->file_copy', '$upload->the_file', '$upload->the_file2', '0', '$dir', '0', '0', '0', '0');";
$query = mysqli_query($link,$sql) or die("Can't Query");

//INSERT INTO `botanic_idea_pic` (`pic_name`, `thumb_name`, `thumb_name2`, `obj_id`, `obj_refcode`, `obj_cover`, `pic_detail`, `listorder`, `pic_open`)
//VALUES ('qq', 'qq', 'qq', '0', 'qqqq', '0', 'qqq', '0', '0');
/////////////////////////
?>
