            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="showobj.php"><i class="fa fa-dashboard"></i> วัตถุจัดแสดง</a></li>
...
$sql = " INSERT INTO `archive_vr` (`vr_dir`, `obj_id`, `obj_refcode`, `vr_direction`) VALUES ('$newdir1', $objectid, '$refcode', 'R') ";
...
////////////////  archive_object VR PIC /////////////////////

//echo "<br> $refcode <br>";

if($delvr == 1)
		{
	      $sql = "DELETE FROM archive_vr WHERE vr_id = '$vrid' ";
		  $query=mysqli_query($link,$sql) or die("Can't Query");
...
$sql = "UPDATE archive_vr SET `vr_direction` = '$dirchange'  WHERE `archive_vr`.`vr_id` = '$vrid' LIMIT 1 ;";
$query=mysqli_query($link,$sql) or die("Can't Query");
...
echo "<div class='box box-primary'>"; // Start box-primary
	...
	echo "<div>";
	$sql3 = "SELECT * FROM `archive_vr` WHERE obj_refcode = '$refcode' ";
		 ...
		 if($vrpic1[1]=="jpg")
			...
			echo "<img src ='../../pic/vr/$result3[vr_dir]/$filevr[$i]' width='150'> ";
				...
				if($result3[vr_direction] == 'R' )
				 {
                 echo "<a href='edit.php?vrid=$result3[vr_id]&objectid=$objectid&refcode=$refcode&dirchange=L'><img src='images/right_arrow.jpg' width ='30'></a>";

				 }
			 else if($result3[vr_direction] == 'L')
				 {
				 echo "<a href='edit.php?vrid=$result3[vr_id]&objectid=$objectid&refcode=$refcode&dirchange=R'><img src='images/left_arrow.jpg' width ='30'></a>";
				 }
///////////  End Check Pic ///////////
                 echo "<a href ='edit.php?vrid=$result3[vr_id]&objectid=$objectid&refcode=$refcode&delvr=1'> <img src ='images/icon_del.gif'> </a> <br>";
	...
	echo "<form name ='formupload' method='post' action='edit.php' enctype='multipart/form-data'>";
...
//upload  ไฟล์download
	...
	echo "<form name ='formupload' method='post' action='model/funcMediaUploadarchive.php' enctype='multipart/form-data'>";
    echo "<div class='form-group'>";
...
//              echo "bpu = $row[bpu_id] <br>";
              ...
              <p>  <a href='model/funcDeleteFileArchive.php?objectid=".$objectid."&type=".$type."&refcode=".$refcode."&file=".$row['bpu_id']."'>
                <img src='images/icon_del2.png'></a>  </p>";
                         ...
                         $secheck = "SELECT * FROM archive_upload WHERE bpu_id = '$bpu_id' ";
...
//echo "bpu1 = $row[bpu_id] $bup $objid <br>";

                                     							}
                           //echo "bpu2 = $row[bpu_id] $bup $objid <br>";
                           $secheckdata = "SELECT * FROM archive_upload_check WHERE bpu_id = '$bup'  ";
...
// echo "open_check_res = $open_check_res bpu3 = $row[bpu_id] $bup  <br>";

$cover = $_REQUEST['cover'];

 //echo "open_check_res = $open_check_res bpu3 = $row[bpu_id] $bup  $cover <br>";
                         ...
                         if ($open_check_res == '1' ) {
                                   ...
                                   echo "<a href='edit.php?cover=0&objectid=$objectid&refcode=$refcode&bpu_id_req=$bpu_id'>
                                   ...
                                   echo "<a href='edit.php?cover=1&objectid=$objectid&refcode=$refcode&bpu_id_req=$bpu_id'>
                               ...
                               if ($cover == '1') {
                                 $update_data = "UPDATE `archive_upload_check`
                                 SET
...
//						<img src='../../pic/archive_upload/".$refcode."/".$row['bpu_file']."' >
//
//						".$row['bpu_file']."
//					</a>
//				<p>
//					<a href='model/funcDeleteFileArchive.php?objectid=".$objectid."&type=".$type."&refcode=".$refcode."&file=".$row['bpu_id']."'><img src='images/icon_del2.png'></a>
//				</p>
//			";
              }
			//echo "</div><!-- /.col-md-2 -->";
...
//      if($deldwload == 1)
//		{
//	      $sql = "DELETE FROM archive_upload WHERE bpu_id = '$row[bpu_id]' ";
//		  $query=mysqli_query($link,$sql) or die("Can't Query");
...
//				  		echo "<a target='_blank' href='../../pic/archive_upload/".$refcode."/".$row['bpu_file']."'><img src='images/pdf.png' width='100'> ".$row['bpu_file']." </a>
//                       <p>
//					<a href='model/funcDeleteFileArchive.php?objectid=".$objectid."&type=".$type."&refcode=".$refcode."&file=".$row['bpu_id']."'><img src='images/icon_del2.png'></a>
//				</p> ";
echo "<div class='col-sm-4' align='center'>";
                        echo "<audio width='250' controls>
  				  		<source src='../../pic/archive_upload/$refcode/$row[bpu_file]' type='audio/mpeg'>
  			     		<embed src='../../pic/archive_upload/$refcode/$row[bpu_file]' width='250'>
						</audio>";
                  		echo "<br>";
                        echo "<p>
					<a href='model/funcDeleteFileArchive.php?objectid=".$objectid."&type=".$type."&refcode=".$refcode."&file=".$row['bpu_id']."'><img src='images/icon_del2.png'></a>
...
echo "</div>";
        ...
        echo "<div class='col-sm-4' align='center'>";
                        echo "<video width='250'  controls>
  								  <source src='../../pic/archive_upload/$refcode/$row[bpu_file]' type='video/mp4'>
  								  <object data='../../archive_upload/$refcode/$row[bpu_file]' width='250' >
...
// ปรับค่าให้ obj_cover อื่นๆให้มีค่าเป็น 0 เพื่อที่จะให้เหลือค่า 1 ค่าเดียว
 ...
 $query=mysqli_query($link,$sql) or die("Can't Query-1");
   ...
   $sql1 = "UPDATE archive_pic SET `obj_cover`='0' WHERE `archive_pic`.`pic_id` ='$picid'";
...
{
//echo "สั่งเปิดรูป";
 $sql123 = "UPDATE archive_pic SET `pic_open`='0' WHERE `archive_pic`.`pic_id` ='$picid'";
 $query123=mysqli_query($link,$sql123) or die("Can't Query-1");
}
else if($openpic == '0')
{
//echo "สั่งปิดรูป";
 $sql123 = "UPDATE archive_pic SET `pic_open`='1' WHERE `archive_pic`.`pic_id` ='$picid'";
 $query123=mysqli_query($link,$sql123) or die("Can't Query-1");
}
...
// $refdata = preg_replace('/[^a-z0-9\_\- ]/i', '', $refcode);
	...
	echo "<div class='box-body'>"; // Start box-body
	echo "<div>
			<a class='btn btn-primary' href=\"JavaScript:newPopup('uploadarchive/index.php?dir=$refcode&objectid=$objectid&refcode=$refcode');\">
				<i class='fa fa-upload fa-lg'></i> อัพโหลดวัตถุจัดแสดง
			</a>
			<a class='btn btn-primary pull-right' href=\"JavaScript:newPopup('model/sortable/index.php?ref=$refcode&type=archive&id=$objectid');\">
...
echo "<tr>";
 $sql3 = "SELECT * FROM `archive_pic` WHERE obj_refcode = '$refcode' ORDER BY listorder ASC";
         $query3=mysqli_query($link,$sql3) or die("Can't Query2");
         $num_rows3=mysqli_num_rows($query3);
    		//  $result3=mysqli_fetch_array($query3);
 ...
 {
  //  if ($cover == '0') {
  //    $updatepicopen = "UPDATE archive_pic SET `pic_open`='1' WHERE `archive_pic`.`pic_id` ='$picid'";
 ...
 if($cover == '1')
 {
 	...
 	echo "<a href ='edit.php?picid=$result3[pic_id]&setpic=0&objectid=$objid&refcode=$refcode'> <img src ='images/icon_set2.png'> </a>"; //Checked
 ...
 echo "<a href ='edit.php?picid=$result3[pic_id]&openpic=0&objectid=$objid&refcode=$refcode'><img src='images/eye-close.png'></a>";
 }
 else
 {
     //  echo "eye = $result3[pic_open]";
 echo "<a href ='edit.php?picid=$result3[pic_id]&openpic=1&objectid=$objid&refcode=$refcode'><img src='images/eye-open.png'></a>";
 }
...
<!------------------------------------------------------------>
	...
	echo "<div class='box box-primary'>"; // Start box-primary
	echo "<div class='box-header'>";
	echo "<h3 class='box-title'>Exibition</h3>";
	echo "</div>";
	echo "<div class='box-body'>"; // Start box-body
	echo "<div>
			<a href=\"http://www.museumspool.com/adt_anurak/index.php/Adapter/get_link_item?museum_code=2&item_code=H1-11/056\" rel='nofollow noreferrer'>
			http://www.museumspool.com/adt_anurak/index.php/Adapter/get_link_item?museum_code=2&item_code=H1-11/056
			</a>
           <br><br>
		  </div>";
?>
