            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">ลบเอกสารจดหมายเหตุ</li>
                    </ol>
                </section>
...
require('connect.php');
    ...
    if($del =='obj')
	  ...
	  echo "<input type='hidden' name='cfdel' value='1'>";
	  //echo "<input type='submit' name='sumbit' value='ลบข้อมูล'>";
	  echo "<button type='submit' name='submit' class='btn btn-danger'>ลบข้อมูล</button>";
	  echo "</form>";
		}
...
if($cfdel == '1')
		{
		 ...
		 echo "<br/><a href='showobj.php'>กลับหน้าเอกสาร</a>";

echo "
<script type=\"text/javascript\">
	window.location=\"showobj.php\";
</script>";
