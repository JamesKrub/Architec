...
$filetype = $filetype[1];
	...
	#echo "<img id='yourImageID' src ='../pic/bigmuse/$refcode/$picname'>";
...
if(($filetype == 'jpg') or ($filetype =='JPG'))
	...
	{
		//echo "../pic/bigmuse/$refcode/$picname";
		echo "<video   controls>
  			  <source src='../pic/bigmuse/$refcode/$picname' type='video/mp4'>
  			  <object data='../pic/bigmuse/$refcode/$picname'  >
    		  </object>
			  </video>";
		echo "<br>";
	}
else if($filetype =='mp3')
	{
		...
		echo "<audio width='200' controls>
  			  <source src='../pic/bigmuse/$refcode/$picname' type='audio/mpeg'>
  			  <embed src='../pic/bigmuse/$refcode/$picname' width='200'>
			  </audio>";
        echo "<br>";
	 }
else if($filetype =='pdf')
	 {
		...
		echo "<script type=\"text/javascript\">
			  ...
			  url: \"../pic/bigmuse/$refcode/$picname\",
			  pdfOpenParams: {
				navpanes: 1,
				view: \"FitV\",
				pagemode: \"thumbs\"
...
<form class='form-horizontal' role='form' name='form1' method='post' action='picdetail.php?picid=$picid&refcode=$refcode&editdetail=1'>
    ...
    <script type='text/javascript' src='WYSIWYG1/nicEdit.js'></script>
