            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="index.php"> เอกสารจดหมายเหตุ</a></li>
...
echo "<a class='btn btn-default pull-right' href='showobj.php'>เอกสารจดหมายเหตุ</a><br><br>";
...
else
{
	if(($permission == 'admin') or ($permission == 'superadmin'))
	{
		$sql = "select * from archive_object where obj_access != '1'";
	}
	else if ($permission =='user')
	{
