            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">ข้อมูลพรรณไม้</li>
                    </ol>
                </section>
...
<div class='callout callout-danger'>
	<h4>ต้องการที่จะลบข้อมูลพรรณไม้</h4>
	<p>
...
<div id='alert-message' class='alert alert-success alert-dismissable'>
	...
	ลบข้อมูลพรรณไม้เสร็จสิ้น
</div>";
}

echo "<a class='btn btn-primary' href='add-plant.php'><i class='fa fa-plus-square fa-lg'></i> เพิ่มข้อมูล</a>";
echo "<a class='btn btn-default pull-right' href='showobj_access-plant.php'> เอกสารรอการอนุมัติ</a><br><br>";
...
echo "<th class='col-sm-1 text-center'>รหัสพรรณไม้</th>";
...
else
{
	if(($permission == 'admin') or ($permission == 'superadmin') or ($permission =='editor'))
	{
		...
		$sql = "select * from botanic_plant_object";
	}
	else if ($permission =='user')
	{
...
while($result=mysqli_fetch_array($rs)){ //วนรอบแสดงข้อมูล
	...
	$sql2 = "SELECT * FROM botanic_plant_pic WHERE obj_refcode = '$objrefcode' ORDER BY obj_cover DESC limit 0,1  ";
	...
	echo "<td><img src ='../../pic/big-plant/$objref/$picname' width='250'></td>";
    ...
    <li><a href='edit-plant.php?objectid=$result[obj_id]&refcode=$result[obj_refcode]'>แก้ไข</a></li>
    <li><a href='model/botanic/delete.php?id=$result[obj_id]&refcode=$result[obj_refcode]&type=plant'>ลบ</a></li>
    <li class='divider'></li>";
