...
if(empty($_GET['ref']) || empty($_GET['type'])) {
  ...
  include_once("../admin/object/connect.php");
  switch($_GET['type']) {
    case 'muse':
      $table = 'muse_pic';
      $redi = 'editmuse';
...
<html>
  ...
  <body>
    ...
    <ul class="sortable" style="padding-left: 0 !important; margin-top: 10px !important;">
      ...
      <?php while($row = mysqli_fetch_array($link,$query)) { ?>
      <li id='item-<?php echo $row['pic_id']; ?>'>
          <img src="../../../../pic/<?php echo $pic."/".$_GET['ref']."/".$row['pic_name']; ?>" style="border: 1px solid #ccc;">
        </li>
      <?php } ?>
    </ul>
