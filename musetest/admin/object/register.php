        ...
        <div class="form-box" id="login-box">
            ...
            <form action="register_save.php" method="post">
                <div class="body bg-gray">
					...
					<div class="form-group">
                        <input type="hidden" name="permission" class="form-control" placeholder="Permission" value="user"/>
                    </div>
					<div class="form-group">
                        <input type="hidden" name="mem_pic" class="form-control" placeholder="mem_pic" value="avatar5.png"/>
                    </div>
                </div>
                <div class="footer">
