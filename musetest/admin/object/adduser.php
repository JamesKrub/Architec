...
<!--------------   Process ----------------->
	...
	######  Start Tab ##########
echo "
<form class='form-horizontal' role='form' name='form1' method='post' action='useradd_todb.php' enctype='multipart/form-data'>
<div class='nav-tabs-custom'>


<ul class='nav nav-tabs'>
	<li class='active'><a href='#tab_1' data-toggle='tab'>เพิ่มผู้ใช้งาน*</a></li>
...
<div class='form-group'>
	...
	<div class='col-sm-10'>
		<input class='form-control' type='text' name ='usn' value='' >
	</div>
</div>
