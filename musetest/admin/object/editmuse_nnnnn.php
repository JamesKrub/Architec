...
echo "<div class='box box-primary'>"; // Start box-primary
	echo "<div class='box-header'>";
	echo "<h3 class='box-title'>ไฟล์ดาวน์โหลด (MP3 , MP4)</h3>";
	echo "</div>";
	echo "<div class='box-body'>"; // Start box-body
	if($download == '1')
	{
...
echo "<td align='center'>";  
                        echo "<audio width='200' controls>
  			     		...
  			     		<embed src='../../pic/museum_upload/$refcode/$row[bpu_file]' width='200'>
						</audio>";
                  		echo "<br>";
                        echo "$row[bpu_file]";
   echo "</td>";               
...
echo "<td align='center'>";            
                        echo "<video width='200'  controls>
  								  ...
  								  <object data='../../museum_upload/$refcode/$row[bpu_file]' width='200' >
	     ...
	     for ($i=0; $i<$num_rows3; $i++) {
				 ...
				 if($line < 3)
			 {
                ...
                // echo "<img src ='../../pic/thumbmuse/thumbmuse-$result3[pic_name]' width='50'> $result3[pic_id] $result3[obj_refcode]$result3[pic_name] <br>";
				  ...
				  {
				  			echo "<a href=\"pic/bigmuse/$nrefcode/$result3[pic_name]\" data-gallery>
							<img src ='../../pic/bigmuse/$nrefcode/$result3[pic_name]' width='200'></a> <br>";
				  }
				  else
				  if($filetype =='mp4')
				  {
