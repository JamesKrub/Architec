...
echo "</table>";
echo "<br>";
echo "<li><a href=\"#\" onclick=\"window.open('createcardfull.php?objectid=$result[obj_id]&refcode=$result[obj_refcode]', 'newwindow', 'width=600, height=550'); return false;\"><img src='images/card_icon.png' width='30'><input type='button' value='MORE'></a></li>";
?>
