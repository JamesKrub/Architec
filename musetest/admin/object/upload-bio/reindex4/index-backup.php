    ...
    <ul>
     ...
     <!-- <li id="arrayorder_<?php echo $id ?>"><?php echo $id?> <?php #echo $name; ?>-->
	  ...
	  $filetype = $filetype[1];
				  ...
				  {
				  echo "<img src ='../../../../pic/big/$refcode/$name' width='170'>";
				  }
				  else
				  if($filetype =='mp4')
				  {
				  			//echo "../../../../pic/big/$refcode/$name";
							echo "<video width='200'  controls>
  								  <source src='../../../../pic/big/$refcode/$name' type='video/mp4'>
  								  <object data='../../../../pic/big/$refcode/$name' width='200' >
				  ...
				  else if($filetype =='mp3')
				  {
				  		...
				  		echo "<audio width='200' controls>
  				  		<source src='../../../../pic/big/$refcode/$name' type='audio/mpeg'>
  			     		<embed src='../../../../pic/big/$refcode/$name' width='200'>
						</audio>";
                  		echo "<br>";
				  }
				  else if($filetype =='pdf')
				  {
				  		...
				  		echo "<a href ='../../../../pic/big/$refcode/$name' target='_blank'><img src='../../images/pdf-icon.png' width='150'></a>";
                  		echo "<br>";
				  }
      ?>
      <?php #echo "$filetype xxxxx <img src ='../../../../pic/big/$refcode/$name' width='170'>"; ?>
