...
$dir = $_REQUEST['dir'];
//$dir = "test";
$path = "../../../pic/big-bio/".$dir;
$thumbpath = "../../../pic/thumb-bio/".$dir;
$thumbpath2 = "../../../pic/thumb2-bio/".$dir;
...
$upload->upload_dir = '../../../pic/big-bio/'.$dir.'/';
...
//$sql = " INSERT INTO `botanic_bio_pic` ( `pic_id` , `pic_name` , `thumb_name` , `thumb_name2` , `obj_refcode` ) VALUES ('' , '$upload->file_copy', '$upload->the_file' , '$upload->the_file2' , '$dir');";
//$query=mysql_query($sql) or die("Can't Query");

$sql = " INSERT INTO `botanic_bio_pic` (`pic_name`, `thumb_name`, `thumb_name2`, `obj_id`, `obj_refcode`, `obj_cover`, `pic_detail`, `listorder`, `pic_open`)
