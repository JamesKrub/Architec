<?php
session_start();
include_once 'onnect.php';

if (!isset($_SESSION['id'])) {
 header("Location: login_test.php");
}

$query = $DBcon->query("SELECT * FROM tbl_users WHERE user_id=".$_SESSION['id']);
...
<title>Welcome - <?php echo $userRow['usr']; ?></title>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><span class="glyphicon glyphicon-user"></span>&nbsp; <?php echo $userRow['usr']; ?></a></li>
