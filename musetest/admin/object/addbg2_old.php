...
$sqledit = "UPDATE muse_bg SET `bg_name` = '$archivename', `bg_desc` = '$archivedesc', `bg_entry` = '$archiveentry',
...
echo "<div class='form-group'>";
echo "<label class='col-sm-2 control-label'>ส่งข้อมูล นิทรรศการ </label>";
echo "<div class='col-sm-10'>";
//echo "<input class='form-control' type='text' name ='archivename' value='$archivename'>";
 echo "<input type='hidden' name='action'value='Item'/>";
 echo "<input name='museum_code' type='hidden' id='museum_code' value='1'>   "; 
...
echo "<div class='box-footer'>"; // Start box-footer
echo "<input type='hidden' name='editdetail' value='1'><button type='submit' name='submit' class='btn btn-primary'><i class='fa fa-upload fa-lg'></i>ส่งข้อมูล นิทรรศการ</button>";
echo "</div>"; // End box-footer
