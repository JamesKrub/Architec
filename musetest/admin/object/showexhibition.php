...
echo "<a class='btn btn-primary' href='addexhibition.php'><i class='fa fa-plus-square fa-lg'></i> เพิ่มนิทรรศการ</a>";
echo "<a class='btn btn-default pull-right' href='shownews_access.php'> นิทรรศการรอการอนุมัติ</a><br><br>";
...
echo "<th class='col-sm-3 text-center'> หัวข้อนิทรรศการ</th>";
...
while($result=mysqli_fetch_array($rs)){ //วนรอบแสดงข้อมูล
	...
	echo "<div class='btn-group'>
                                            ...
                                            <ul class='dropdown-menu' role='menu'>
                                                ...
                                                <li><a href='editnews.php?newsid=$result[news_id]'>ลบ</a></li>";
                                           echo" </ul>
                                        </div>";
	echo "</td>";
$i=$i+1;
