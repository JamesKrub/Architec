...
//	mysqli_commit($link1);    
//    $dateapi = new DateTime();
//    $dateapi = $dateapi->format('Y-m-d h:i:s');  
//$sql1 = "UPDATE `culture_api`.`itemsnew`
// SET
//  `obj_id`='$objid' ,
// `obj_refcode`='$refcode' ,
// `obj_title` ='$title',
...
//`obj_history_display` = '$historydisplay',
//`obj_acquis_display` = '$acquisdisplay'
//WHERE `itemsnew`.`obj_refcode` = '$refcode'
//
//
//
//
...
//fetching data in descending order (lastest entry first)
 $sql = "select * from muse_object  where obj_id = '$objectid'";
         ...
         $result=mysqli_fetch_array($query);
            ...
            $oldrefcode = $result[old_obj_refcode];
...
$cover = $_REQUEST['cover'];
 ...
 //echo "open_check_res = $open_check_res bpu3 = $row[bpu_id] $bup  $cover <br>";
                         ...
                         if ($open_check_res == '1' ) {
                                   ...
                                   echo "<a href='editmuse.php?cover=0&objectid=$objectid&refcode=$refcode&bpu_id_req=$bpu_id'>
                                   ...
                                   echo "<a href='editmuse.php?cover=1&objectid=$objectid&refcode=$refcode&bpu_id_req=$bpu_id'>
...
//		 echo "
//		<div id='alert-message-cover' class='alert alert-success alert-dismissable'>
//			<i class='fa fa-check'></i>
//			<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
//			ยกเลิกเป็นภาพปก
//		</div>"; 
...
// $refdata = preg_replace('/[^a-z0-9\_\- ]/i', '', $refcode);
    ...
    //echo "Output1 : ".strtolower($CovertedText)."<br>";    
    //echo "Output2 : ".strtolower(วกก.H1-013)."<br>";  
   // echo "Output3 : ".strtolower($data)."<br>";   
//    echo "Output4 : ".ConvertTH_EN($data)."<br>"; 
    $ref = ConvertTH_EN($data);
//    echo "Output5 : ".$ref."<br>";   
//    echo "Outpu6 : ".$refcode."<br>";         
	echo "</div>";
	echo "<div class='box-body'>"; // Start box-body
	echo "<div>
			<a class='btn btn-primary' href=\"JavaScript:newPopup('uploadmuse/index.php?dir=$ref&objectid=$objectid&refcode=$refcode');\">
...
$foldref =$result3['folder_refcode'];        
  ...
  if($line < 3)
 {
  echo "<td align='center'>";
 	...
 	if(($filetype == 'jpg') or ($filetype =='jpeg') or ($filetype =='png') or ($filetype =='PNG') or ($filetype =='JPEG') or ($filetype == 'JPG'))
 	{
            ...
            echo "<a href=\"../../pic/bigmuse/$foldref/$result3[pic_name]\" data-gallery>
 			       <img src ='../../pic/bigmuse/$foldref/$result3[pic_name]' width='200'></a> <br>";
 	}
 	else
