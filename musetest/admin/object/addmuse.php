...
//}
    ...
    (`obj_id`, `obj_refcode`,`old_obj_refcode`, `obj_title`,`obj_titleeng`, `obj_datecreate`, `obj_level`, `obj_extent`, `obj_creator`, `obj_bio`, `obj_dateacc`, `obj_history`, `obj_acquis`, `obj_scope`, `obj_appraisal`, `obj_accruals`, `obj_arrangement`,
    ...
    `obj_acquis_display`, `obj_downloadfile`, `obj_download`, `obj_countdownload`, `obj_cate2`, `obj_cate3`)
       VALUES (NULL, '$refcode','$oldrefcode', '$title','$titleeng', '$datecreate', '$level', '$extent', '$creator', '$bio', '$dateacc', '$history', '$acquis', '$scope', '$appraisal', '$accruals', '$arrangement', '$legal', '$condition', '$copyright', '$lang', '$physicals','$physicalseng',
       '$aids', '$location', '$existence', '$related', '$associated', '$pubnote', '$note', '$data', '$category', '$access', '$id', '$keyword', '$approve', '$relation',
