...
// echo "xxx $dir";
$path = "../../../pic/big_architec/".$dir;
$thumbpath = "../../../pic/thumb_architec/".$dir;
$thumbpath2 = "../../../pic/thumb2_architec/".$dir;
...
$max_size = 100000*100000; // the max. size for uploading
$upload->upload_dir = '../../../pic/big_architec/'.$dir.'/';
...
$sql = "INSERT INTO `architec_pic` (`archPic_Name`, `archThumb_Name`, `archThumb_Name2`, `archObj_Id`
        , `archObj_Refcode`,`archFolder_Refcode`, `archObj_Cover`, `archPic_Detail`
        , `archListorder`, `archPic_Open`)
VALUES ('$upload->file_copy', '$upload->the_file', '$upload->the_file2', '0'
        , '$refcode','$dir', '0', ''
        , '0', '1');";
$query = mysqli_query($link,$sql) or die("Can't Query");
